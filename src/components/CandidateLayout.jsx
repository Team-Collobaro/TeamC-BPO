...
const navItems = [
  ...
  { to: '/candidate/joining-fee', label: 'Pay Joining Fee' },
  { to: '/candidate/assessment', label: 'Questionnaire' },
  { to: '/candidate/results', label: 'Results & Certificate' },
  { to: '/candidate/profile', label: 'My Profile' },
  { to: '/candidate/reactivate', label: 'Reactivation' },
  { to: '/candidate/payments', label: 'Payments' }
];
